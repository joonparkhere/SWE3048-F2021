    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">간편 로그인</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body login-container">
                <a type="button" class="btn btn-outline-dark login" href="/oauth2/authorization/github">
                    <div class="login-img">
                ...
                <a type="button" class="btn btn-outline-dark login" href="/oauth2/authorization/google">
                    <div class="login-img">
